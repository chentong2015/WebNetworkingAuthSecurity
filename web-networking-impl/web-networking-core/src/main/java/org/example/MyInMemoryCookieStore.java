...
// TODO. 自定义服务端使用内存存储的CookieStore
// - cookie具有特定的过期时间hasExpired()
// - cookie在添加时需要先删除原来存在的
public class MyInMemoryCookieStore implements CookieStore {
    ...
    // When a cookie removed from main data structure (i.e. cookieJar), it won't be cleared in domainIndex & uriIndex.
